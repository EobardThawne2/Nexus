  ...
  return (
    <div className="nexus-container legal-page">
      <div className="nexus-card" style={{ maxWidth: '800px', margin: '2rem auto', textAlign: 'left' }}>
        <h1 style={{ color: '#fff', marginBottom: '1.5rem' }}>Terms & Conditions</h1>
        ...
        <h3 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>2. Automated Provisioning</h3>
        <p style={{ color: 'var(--text-secondary)' }}>
        ...
        <h3 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>3. Cryptographic Non-Repudiation</h3>
        <p style={{ color: 'var(--text-secondary)' }}>
        ...
        <h3 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>4. DPDP Act Compliance</h3>
        <p style={{ color: 'var(--text-secondary)' }}>
