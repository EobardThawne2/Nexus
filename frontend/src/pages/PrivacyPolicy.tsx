  ...
  return (
    <div className="nexus-container legal-page">
      <div className="nexus-card" style={{ maxWidth: '800px', margin: '2rem auto', textAlign: 'left' }}>
        <h1 style={{ color: '#fff', marginBottom: '1.5rem' }}>Privacy Policy</h1>
        ...
        <h3 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>3. Purpose of Processing</h3>
        <p style={{ color: 'var(--text-secondary)' }}>
        ...
        <h3 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>4. Your Rights as a Data Principal</h3>
        <p style={{ color: 'var(--text-secondary)' }}>
        ...
        <h3 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>5. Grievance Redressal</h3>
        <p style={{ color: 'var(--text-secondary)' }}>
