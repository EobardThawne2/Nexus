...
Automated testing of the orchestrator pipeline against 5 challenging test profiles.
Outputs pass/fail metrics for skill identification, format validity, and schema compliance.
"""
...
TEST_PROFILES: List[Dict[str, Any]] = [
    {
        ...
        "linkedin_url": "https://linkedin.com/in/sumeer-khattar",
        "expected_skills_subset": ["Python"],
        "description": "Real GitHub profile with diverse language footprint."
    },
    {
        "name": "Frontend Specialist",
        "github_username": "nonexistent-user-404-xyz",
        "linkedin_url": "https://linkedin.com/in/jane-doe-frontend",
        "expected_skills_subset": ["TypeScript"],
        "description": "Triggers fail-soft mock fallback for GitHub scraping."
    },
    {
        "name": "ML/AI Researcher",
        "github_username": "torvalds",
        "linkedin_url": "https://linkedin.com/in/ml-researcher-phd",
        "expected_skills_subset": ["C"],
        "description": "High-profile account. Validates language extraction at scale."
    },
    {
        "name": "DevOps Engineer",
        "github_username": "kelseyhightower",
        "linkedin_url": "https://linkedin.com/in/devops-lead",
        "expected_skills_subset": ["Go"],
        "description": "Validates correct language parsing for Go-dominant repos."
    },
    {
        "name": "Empty Profile Edge Case",
        "github_username": "",
        "linkedin_url": "https://linkedin.com/in/",
        "expected_skills_subset": [],
        "description": "Edge case: empty inputs should trigger fail-soft cleanly."
    }
]
...
async def run_eval_profile(profile: Dict[str, Any]) -> Dict[str, Any]:
    ...
    results["checks"]["github_has_required_keys"] = all(
        k in github_data for k in ["top_languages", "total_commits_last_year", "repos_analyzed", "top_repos"]
    )
    ...
    results["checks"]["linkedin_has_required_keys"] = all(
        k in linkedin_data for k in ["recent_titles", "years_of_experience", "industry_keywords"]
    )
    ...
    for i, profile in enumerate(TEST_PROFILES):
        ...
        for check_name, check_val in checks.items():
            if isinstance(check_val, bool):
                ...
                color = "\033[92m" if check_val else "\033[91m"
                print(f"       {color}[{status_icon}]\033[0m {check_name}")
            else:
