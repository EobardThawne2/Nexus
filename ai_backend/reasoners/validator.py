...
async def generate_questions(match_id: str, profile_skills: list, top_repos: list=None) -> InterviewQuestions:
    ...
    system_prompt = "You are VALIDATOR, an expert technical interviewer AI. Based on the candidate's core skills and top GitHub repositories, generate exactly 3 highly technical, tailored interview questions to test their true depth of knowledge."
...
async def evaluate_answers(match_id: str, validation_id: str, questions: list, answers: list) -> ValidationEvaluation:
    ...
    system_prompt = "You are VALIDATOR, an expert technical interviewer AI. Evaluate the candidate's answers to the technical questions. Output a fair validation_score between 0.0 and 1.0 based on technical accuracy and depth."
