...
LINKEDIN_MOCK_PROFILE: Dict[str, Any] = {
    ...
    "industry_keywords": ["Distributed Systems", "Machine Learning", "Cloud Architecture"],
...
def scrape_linkedin(url: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "recent_titles": ["Software Engineer", f"Lead Developer at {username.capitalize()} Corp"],
            "years_of_experience": round(random.uniform(3.0, 8.0), 1),
            "industry_keywords": ["Scalable Architecture", "System Design", "Agile Leadership"],
